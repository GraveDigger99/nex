    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (slider) {
                ...
                var sliderValue = document.getElementById("slider-span");
        ...
        function initSliders() {
            if (document.querySelector(".blog-inner__slider")) new core(".blog-inner__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        document.querySelector(".sign-in__body");
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (targetElement.closest(".sign-in__icon")) {
                ...
                document.documentElement.classList.toggle("sign-in-open");
                document.documentElement.classList.remove("menu-open");
            ...
            } else document.documentElement.classList.remove("blog-open");
            if (targetElement.closest(".form-security__icon")) document.querySelector("input.form-security__input[type=password]").type = "text";
            if (targetElement.closest(".select__title")) {
                document.documentElement.classList.toggle("sel-number-open");
                document.documentElement.classList.toggle("lock");
            }
            if (targetElement.closest(".wrapper-form-data-conformation__close")) {
                document.documentElement.classList.remove("sel-number-open");
                document.documentElement.classList.toggle("lock");
            }
        ...
        const FormRadio = document.querySelector(".dark-mode__icon");
        FormRadio.addEventListener("click", (function darkMode(e) {
            var SetTheme = document.body;
            SetTheme.classList.toggle("dark-mode");
            var theme;
            if (SetTheme.classList.contains("dark-mode")) {
